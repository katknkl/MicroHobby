      ...
      <main className="container max-w-6xl mx-auto px-4 md:px-6 py-8">
        ...
        <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-4">
          {filteredHobbies.map((hobby) => (
            <Card 
              key={hobby.id} 
              className="p-5 hover:shadow-lg transition-all hover:-translate-y-1 cursor-pointer group"
            >
              <div className="flex items-start justify-between mb-3">
                ...
                <Button
                  ...
                  className={favorites.includes(hobby.id) ? "text-hobby-coral" : "text-muted-foreground opacity-0 group-hover:opacity-100 transition-opacity"}
                >
